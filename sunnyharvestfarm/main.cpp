...
customers.emplace_back(glm::vec3(0.0f, 0.5f, 15.0f), glm::vec3(1.0f, 1.0f, 0.5f), glm::vec3(0.9f, 0.5f, 0.2f));

customers.emplace_back(glm::vec3(0.0f,0.5f,12.0f), glm::vec3(1.0f, 1.0f, 0.5f), glm::vec3(0.9f, 0.5f, 0.2f));
// 캐릭터 생성
